  ...
  return (
    <Card className="border-amber-200 bg-amber-50 text-amber-950 dark:border-amber-900/60 dark:bg-amber-950/30 dark:text-amber-100">
      <CardHeader className="flex flex-row items-start gap-3 space-y-0 p-4 sm:p-6">
        <AlertTriangle className="mt-1 h-4 w-4 shrink-0 sm:h-5 sm:w-5" />
        <div>
          <CardTitle className="text-base sm:text-lg">{dashboard ? 'Waiting verification' : 'Not verified'}</CardTitle>
          <CardDescription className="text-xs text-amber-900/80 sm:text-sm dark:text-amber-100/80">
